...
(async () => {
    ...
    const turnkey = new sdk_server_1.TurnkeyServerClient({
    ...
    const algorandAddress = algosdk_1.default.encodeAddress(pubKeyBytes);
    console.log(`   → algorandAddress (58-char Base32): ${algorandAddress}`);
    // Verify address derivation
    const isValid = algosdk_1.default.isValidAddress(algorandAddress);
    console.log(`   → algosdk.isValidAddress(): ${isValid}`);
    // Verify round-trip
    const decoded = algosdk_1.default.decodeAddress(algorandAddress);
...
//# sourceMappingURL=turnkey-smoke-test.js.map